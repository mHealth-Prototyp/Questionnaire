import {Patient, Questionnaire, QuestionnairePublicationStatus} from '@i4mi/fhir_r4';
...
export const defaultUserQuestionnaire: Questionnaire = {
  resourceType: 'Questionnaire',
  status: QuestionnairePublicationStatus.UNKNOWN
};
